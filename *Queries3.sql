...
-- ORDER BY first_name;  --Ascending Order or write ASC
...
LIMIT 10 OFFSET 5;  -- ["OFFSET 5", will skip the first five rows. So this line will return the 
                    --data of next 10 date_of_birth i.e. from 6 to 15 (both included)].
