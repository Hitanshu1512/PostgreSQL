...
-- This function capitalize the initial chaaracter of every word
-- SELECT INITCAP(movie_name) as movie_names from movies
-- WHERE movie_lang = 'Korean'
-- OR movie_lang = 'Chinese';



-- SELECT first_name, reverse(first_name) AS rev_first_name from directors;



-- Slicing from left and right (can be used with negative int also)
select Left(first_name, 1) as initials, right(last_name, 3) as Right_3 from directors;
