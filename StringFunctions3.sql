...
/* 
Insert data into mocies_actors table
*/
...
-------- SUBSTRING('Column', starting_point, length) ---------
-------- 'column'::<type_cast> is used to convert any non string column into a string !

SELECT movie_name, SUBSTRING(movie_name, 1, 6) as sub_movie_name, 
SUBSTRING(release_date::TEXT, 1, 7) as sub_release
from movies;

--------------------------------------------------------------

-- SELECT CONCAT_WS(':', Left(first_name, 1), Left(last_name, 1)) from actors
